/*
nbtscan - A benign application used to demonstrate an EDR detection.
This IS NOT the official nbtscan application.
...
std::int_fast32_t main(std::int_fast32_t argc, char* argv[])
{
	...
	const std::string helpText =
		"Usage:\n\n"
		"  nbtscan.exe [options] <parameters>\n\n"
		"    [options]\n"
		"      -h  Print this help.\n\n"
		"    <parameters>\n"
		"      Parameters used with the official nbtscan.\n\n"
		"Examples:\n\n"
		"  nbtscan.exe -d <ipnetwork>/<maskbits>\n"
		"  nbtscan.exe -vh <ipnetwork>/<maskbits>\n\n";
