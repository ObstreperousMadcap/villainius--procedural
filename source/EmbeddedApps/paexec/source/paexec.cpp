/*
paexec - A benign application used to demonstrate an EDR detection.
This IS NOT the official paexec application.
...
std::int_fast32_t main(std::int_fast32_t argc, char* argv[])
{
	...
	const std::string helpText =
		"Usage:\n\n"
		"  paexec.exe [options] <parameters>\n\n"
		"    [options]\n"
		"      -h  Print this help.\n\n"
		"    <parameters>\n"
		"      Parameters used with the official paexec.\n\n"
		"Examples:\n\n"
		"  paexec.exe \\\\<ipaddress> --spoof-mac 0 <filename.exe>\n"
		"  paexec.exe \\\\<ipaddress> -u <username> -p <password> -s <filename.exe>\n"
		"  paexec.exe \\\\<ipaddress> -u <username> -p <password> -i -c <filename.exe>\n\n";
