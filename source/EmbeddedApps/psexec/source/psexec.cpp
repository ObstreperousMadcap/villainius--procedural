/*
psexec - A benign application used to demonstrate an EDR detection.
This IS NOT the official psexec application.
...
std::int_fast32_t main(std::int_fast32_t argc, char* argv[])
{
	...
	const std::string helpText =
		"Usage:\n\n"
		"  psexec.exe [options] <parameters>\n\n"
		"    [options]\n"
		"      -h  Print this help.\n\n["
		"    <parameters>\n"
		"      Parameters used with the official psexec.\n\n"
		"Examples:\n\n"
		"  psexec.exe \\\\<ipaddress> -u <username> -p <password> <filename.exe>\n"
		"  psexec.exe \\\\<hostname> <filename.exe> -an\n"
		"  psexec.exe \\\\<ipaddress> <filename.exe> -ab\n\n";
