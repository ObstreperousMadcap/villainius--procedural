...
std::int_fast32_t main(std::int_fast32_t argc, char* argv[])
{
	...
	const std::string helpText =
		"Usage:\n"
		"  wce.exe [options] <modules>\n\n"
		"      -h            Print this help.\n"
		"      -p <seconds>  Pause wce.exe for <seconds> before exiting.\n"
		"      -m <modules>  Module names, commands, or parameters used with the\n"
		"                    official wce.exe. This must be the *final* option.\n"
		"Examples:\n\n"
		"  wce.exe -p 15 -m -a\n"
		"  wce.exe -p 15 -m -w -o hashfile.txt\n"
		"  wce.exe -p 15 -m -g <cleartextpassword>\n"
		"  wce.exe -p 15 -m -s <username>:<domain>:<lmhash>:<nthash>\n"
		"  wce.exe -p 15 -m -s <username>:<domain>:<lmhash>:<nthash> -c <program>\n";
